        ...
        <div className="relative border-black border-2 p-10">
          <div>
            ...
            <Button
              ...
              title="alocar"
              type="submit"
              className="w-28 absolute mt-2 flex items-center justify-center right-10"
            />
          </div>
                ...
                <tr>
                  ...
                  <td className="border-black border-2">
                    <Button
                      ...
                      title="deletar"
                      type="submit"
                      className="w-28 y-10 right-0 bg-red-700 hover:text-red-700 hover:border-red-700 mt-0"
                    />
                  </td>
                </tr>
              </tbody>
